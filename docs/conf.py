# -*- coding: utf-8 -*-
#
# flask_atlassian_connect documentation build configuration file, created by
# sphinx-quickstart on Thu Jun 15 14:21:11 2017.
#
...
#
try:
    release = pkg_resources.get_distribution('Flask-AtlassianConnect').version
except pkg_resources.DistributionNotFound:
    print('To build the documentation, the distribution information of')
    print('Flask-AtlassianConnect has to be available.  Either install the package')
...
htmlhelp_basename = 'flask_atlassian_connectdoc'
